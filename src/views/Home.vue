            ...
            <section>
                <div class="">
                    ...
                    <div class="carousel-inner">
                        ...
                        <img src="../assets/images/banner-bg.png" class="d-block w-100 slide-img" alt="...">
                        <div class="carousel-caption ">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-2 py-md-0 py-4">
                                <img class="welcome-icon" src="../assets/images/img4.png" alt="">
                                </div>
                                <div class="col-md-4">
                                <div class="">
                ...
                <div class="bg-1">
                    ...
                    <div class="row text-center">
                        <div class="col-md-4">
                        <p class="txt-4 py-2 font-size-22">SECURE</p>
                        </div>
                        <div class="col-md-4 border-end border-white border-start">
                        <p class="txt-4 py-2 font-size-22">RELIABALE</p>
                        </div>
                        <div class="col-md-4 py-2">
                        <p class="txt-4 font-size-22">FAST</p>
                        </div>
                    </div>
                    </div>
                </div>
